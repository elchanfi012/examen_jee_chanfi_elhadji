...
/**
 * Servlet implementation class UserAddAdminSErvlet
 */
public class UserAddAdminSErvlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(session != null) {
			if(session.getRole().equalsIgnoreCase("admin")) {
				request.getRequestDispatcher("/user_add_admin.jsp").forward(request, response);
			}
			else {
						...
						try {
							...
							if(user != null) {
								...
								doGet(request, response);
							        ...
							        user = new User(username, password, lastname, firstname, image_link, employed_at, phone_number, role);
